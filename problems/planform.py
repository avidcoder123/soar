...
def planform_problem(bounds, fourier_names, n_list, lift_goal, initial_airfoil, v_infty, mu, rho, alpha_geo, tolerance, maxiter):
    prob = om.Problem()
    ...
    prob.model.add_subsystem("circulation", FourierCoefficients(fourier_names, n_list))
